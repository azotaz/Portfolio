...
export default function Présentation({ id }) {
  return (
    <div id={id} className='Présentation'>
        ...
        <p className='texte'>J'ai fais le souhait de me réorienter après une carrière dans le domaine des Energies,
        ...
        <p className='passion'> Je suis quelqu'un de simple qui m'intesse a tous. Je fais du sport plusieurs fois par semaine, 
        j'aime les animaux, cuisiner , voyager et découvrir , l'informatique, les jeux vidéo et profiter de la plage et de ses
        activités quand la saison ci prête.
        </p>
    </div>
  )
}
